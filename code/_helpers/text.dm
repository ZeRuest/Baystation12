...
/proc/impU2A(t)
	//¨, ¸
	t = replacetextEx(t, "\\u0401", "\\xa8")
	t = replacetextEx(t, "\\u0451", "\\xb8")
	//À-Ï
	t = replacetextEx(t, "\\u0410", "\\xc0")
	t = replacetextEx(t, "\\u0411", "\\xc1")
	t = replacetextEx(t, "\\u0412", "\\xc2")
	t = replacetextEx(t, "\\u0413", "\\xc3")
	t = replacetextEx(t, "\\u0414", "\\xc4")
	t = replacetextEx(t, "\\u0415", "\\xc5")
	t = replacetextEx(t, "\\u0416", "\\xc6")
	t = replacetextEx(t, "\\u0417", "\\xc7")
	t = replacetextEx(t, "\\u0418", "\\xc8")
	t = replacetextEx(t, "\\u0419", "\\xc9")
	t = replacetextEx(t, "\\u041a", "\\xca")
	t = replacetextEx(t, "\\u041b", "\\xcb")
	t = replacetextEx(t, "\\u041c", "\\xcc")
	t = replacetextEx(t, "\\u041d", "\\xcd")
	t = replacetextEx(t, "\\u041e", "\\xce")
	t = replacetextEx(t, "\\u041f", "\\xcf")
	//Ð-ß
	t = replacetextEx(t, "\\u0420", "\\xd0")
	t = replacetextEx(t, "\\u0421", "\\xd1")
	t = replacetextEx(t, "\\u0422", "\\xd2")
	t = replacetextEx(t, "\\u0423", "\\xd3")
	t = replacetextEx(t, "\\u0424", "\\xd4")
	t = replacetextEx(t, "\\u0425", "\\xd5")
	t = replacetextEx(t, "\\u0426", "\\xd6")
	t = replacetextEx(t, "\\u0427", "\\xd7")
	t = replacetextEx(t, "\\u0428", "\\xd8")
	t = replacetextEx(t, "\\u0429", "\\xd9")
	t = replacetextEx(t, "\\u042a", "\\xda")
	t = replacetextEx(t, "\\u042b", "\\xdb")
	t = replacetextEx(t, "\\u042c", "\\xdc")
	t = replacetextEx(t, "\\u042d", "\\xdd")
	t = replacetextEx(t, "\\u042e", "\\xde")
	t = replacetextEx(t, "\\u042f", "\\xdf")
	//à-ï
	t = replacetextEx(t, "\\u0430", "\\xe0")
	t = replacetextEx(t, "\\u0431", "\\xe1")
	t = replacetextEx(t, "\\u0432", "\\xe2")
	t = replacetextEx(t, "\\u0433", "\\xe3")
	t = replacetextEx(t, "\\u0434", "\\xe4")
	t = replacetextEx(t, "\\u0435", "\\xe5")
	t = replacetextEx(t, "\\u0436", "\\xe6")
	t = replacetextEx(t, "\\u0437", "\\xe7")
	t = replacetextEx(t, "\\u0438", "\\xe8")
	t = replacetextEx(t, "\\u0439", "\\xe9")
	t = replacetextEx(t, "\\u043a", "\\xea")
	t = replacetextEx(t, "\\u043b", "\\xeb")
	t = replacetextEx(t, "\\u043c", "\\xec")
	t = replacetextEx(t, "\\u043d", "\\xed")
	t = replacetextEx(t, "\\u043e", "\\xee")
	t = replacetextEx(t, "\\u043f", "\\xef")
	//ð-ÿ
	t = replacetextEx(t, "\\u0440", "\\xf0")
	t = replacetextEx(t, "\\u0441", "\\xf1")
	t = replacetextEx(t, "\\u0442", "\\xf2")
	t = replacetextEx(t, "\\u0443", "\\xf3")
	t = replacetextEx(t, "\\u0444", "\\xf4")
	t = replacetextEx(t, "\\u0445", "\\xf5")
	t = replacetextEx(t, "\\u0446", "\\xf6")
	t = replacetextEx(t, "\\u0447", "\\xf7")
	t = replacetextEx(t, "\\u0448", "\\xf8")
	t = replacetextEx(t, "\\u0449", "\\xf9")
	t = replacetextEx(t, "\\u044a", "\\xfa")
	t = replacetextEx(t, "\\u044b", "\\xfb")
	t = replacetextEx(t, "\\u044c", "\\xfc")
	t = replacetextEx(t, "\\u044d", "\\xfd")
	t = replacetextEx(t, "\\u044e", "\\xfe")
	t = replacetextEx(t, "\\u044f", "&#255;")
	t = replacetextEx(t, "\\u044f", "&#1103;")
	return t
